  ...
  return (
    <Container >
        <Content>
            ...
            <Page3 id="Page3">
                <ColoredSide id="vector">
                    <SideTop>
                        <AnimatedTextLeft id="vector" data-aos="fade-right" data-aos-delay="700">Trabalhe...</AnimatedTextLeft>
                    </SideTop>
                    <SideMid>
                        <img className="WFH1" id="vector" src={WFH1} alt="WFH1" />
                    </SideMid>
                    <SideBottom >
                ...
                <WhiteSide id="FullColoredSize2" >
                    <SideTop id="vector">
                        <GoBack href="#Page2" className="backAreaBlack"><BackArrow className="backIconBlack"/><p className="backTextBlack">Voltar</p></GoBack>
                    </SideTop>
                    <SideMid id="SideMid">
                        <img className="WFH2" id="vector" src={WFH2} alt="WFH2" />
                        <AnimatedTextLeft id="AnimatedText2" data-aos="fade-up" data-aos-delay="700">Trabalhe...</AnimatedTextLeft>
                        <AnimatedTextRight id="AnimatedText" data-aos="fade-right" data-aos-delay="1400">...em casa!</AnimatedTextRight>
                    </SideMid>
                    <SideBottom id="vector" />
                </WhiteSide>
            </Page3>
            <Page4 id="Page4">
                <SideTop>
                ...
                <SideMid>
                    <Page1Title id="Title">Em caso de sintomas...</Page1Title>
                    <Page1Description style={{ marginTop: 30 }} id="Descritpion2">Se caso apresente sintomas da doença como febre, tosse, dor de garganta, falta de ar, perda do paladar, evite sair ou ter contato físico com outras pessoas, incluindo os familiares, principalmente, idosos e doentes crônicos. Caso os sintomas fiquem intensivos, é aconselhado ir para o posto de saúde de seu bairro, onde irá ser encaminhado para um hospital em piores casos.</Page1Description>
                    <img className="WFH3" id="vector" src={WFH3} alt="WFH1" />
                </SideMid>
                <SideBottom>
                    <BackToTop id="BackToTop" href="#page1">
                        Voltar ao topo
                    </BackToTop>
                </SideBottom>
            </Page4>
